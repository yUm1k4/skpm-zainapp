...
<div class="modal fade bs-example-modal-lg" id="modaltambah" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="formKategori" id="form" action="<?= site_url('pengaduan-kategori/simpandata') ?>">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_kategori" name="nama_kategori" class="form-control " required data-parsley-required-message="Kategori harus diisi jika ingin menyimpan" data-parsley-length="[3,40]" data-parsley-length-message="Minimal 3 karakter, maksimal 40 karakter" data-parsley-trigger="keyup">
