...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('/vendors/404') ?>/style.css">
...
<body>
        ...
        <div class="container">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z" />
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <h2>UH OH! Halaman tidak ditemukan.</h2>
                    <p> Mohon maaf, Bagaimana kamu bisa sampai ke sini? Jika ingin kembali silahkan klik tombol di bawah ini.
                    </p>
                    <a href="<?= previous_url() ?>" class="btn biru mb-5">Kembali</a>
                </div>
            </div>
        </div>
    </main>
    ...
    <script src="<?= base_url('/vendors/404') ?>/script.js"></script>
