...
<div class="card-box mb-30">
    <div class="pd-20">
        <div class="row">
            ...
            <div class="col-auto">
                <a href="<?= base_url('/petugas/create') ?>" class="btn btn-sm btn-primary btn-icon-split">
                    <span class="icon">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= xss(limit_word($p->fullname, 3)) ?></td>
                            <td><?= xss($p->username) ?></td>
                            <td><?= xss($p->nik) ?></td>
                            <td><?= xss($p->no_hp) ?></td>
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                        <a href="#" class="dropdown-item" id="detailData" data-toggle="modal" data-target="#show-petugas-modal" type="button" data-userid="<?= $p->userid; ?>" data-username="<?= $p->username; ?>" data-email="<?= $p->email; ?>" data-fullname="<?= $p->fullname; ?>" data-nik="<?= $p->nik; ?>" data-nohp="<?= $p->no_hp; ?>" data-alamat="<?= $p->alamat; ?>">
...
<div class="modal fade bs-example-modal-lg" id="show-petugas-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Detail Data Petugas</h4>
