        ...
        <ol class="ordered-list text-dark pl-0">
            ...
            <li><span><b>Definisi :</b></span>
                <ol class="ordered-list-alpha pl-0">
                    <li><span>Sistem Keluhan dan Pengaduan Masyarakat <?= setting()->nama_aplikasi_frontend ?> adalah layanan penyampaian semua aspirasi dan pengaduan masyarakat melalui website.</span></li>
                    <li><span>Pengguna adalah pihak yang menggunakan layanan <?= setting()->nama_aplikasi_frontend ?> untuk menyampaikan keluhan, aspirasi, laporan, pengaduan, komentar dan permintaan informasi terkait dengan pelayanan publik.</span></li>
                    <li><span>Akun adalah informasi yang digunakan oleh pengguna, pengelola, dan penanggung jawab untuk masuk ke <?= setting()->nama_aplikasi_frontend ?> </span></li>
            ...
            <li><span><b>Pentingnya Ketentuan Penggunaan Layanan</b></span>
                <ol class="ordered-list-alpha pl-0">
                    <li><span>Dengan mengunduh, mengakses, menjelajahi dan atau menggunakan layanan <?= setting()->nama_aplikasi_frontend ?> ini, berarti Pengguna setuju untuk terikat oleh Ketentuan Penggunaan Layanan ini. Jika Pengguna tidak setuju dengan Syarat dan Ketentuan Penggunaan ini, pengguna harus segera menghentikan akses dan penggunaan layanan yang ditawarkan pada <?= setting()->nama_aplikasi_frontend ?></span></li>
                    <li><span>Kebijakan ini berlaku untuk semua pengguna layanan <?= setting()->nama_aplikasi_frontend ?></span></li>
                </ol>
            </li>
            <li><span><b>Syarat Penggunaan</b></span>
                <ol class="ordered-list-alpha pl-0">
                    <li><span>Aplikasi <?= setting()->nama_aplikasi_frontend ?> hanya digunakan untuk menyampaikan keluhan, aspirasi, laporan, pengaduan, komentar dan permintaan informasi terkait dengan pelayanan publik.</span></li>
                    <li><span>Pengguna tidak diperbolehkan untuk menggunakan identitas pribadi milik orang lain untuk menggunakan layanan <?= setting()->nama_aplikasi_frontend ?> dan wajib menjaga kerahasiaan informasi yang didapatkan di aplikasi <?= setting()->nama_aplikasi_frontend ?>.</span></li>
                    <li><span>Pengguna tidak diperkenankan menyalahgunakan data dan informasi yang terdapat dalam layanan aplikasi <?= setting()->nama_aplikasi_frontend ?> untuk tujuan yang merugikan pihak lain serta melanggar peraturan perundang-undangan yang berlaku.</span></li>
                    ...
                    <li><span>Penggunaan layanan <?= setting()->nama_aplikasi_frontend ?> adalah untuk kepentingan pribadi, non-komersial, dan tidak boleh digunakan untuk tujuan yang merugikan pihak lain.</span></li>
            ...
            <li><span><b>Kerahasiaan dan Informasi Pribadi</b></span>
                <ol class="ordered-list-alpha pl-0">
                    <li><span>Dengan menggunakan layanan pengaduan ini, pengguna setuju dan memahami bahwa informasi yang terkait dengan data pribadi dan data pengaduan atau aspirasi dari pengguna akan diberikan kepada penyedia layanan. Namun demikian, pengelola layanan memberikan jaminan kerahasiaan data dan informasi pada <?= setting()->nama_aplikasi_frontend ?>.</span></li>
                    <li><span>Layanan <?= setting()->nama_aplikasi_frontend ?> mengumpulkan data pribadi pengguna sebagai jaminan keabsahan dari aduan atau aspirasi yang disampaikan. Adapun data pribadi yang dikumpulkan adalah sebagai berikut:</span>
            ...
            <li><span><b>Kewajiban Pengelola <?= setting()->nama_aplikasi_frontend ?></b></span>
                <ol class="ordered-list-alpha pl-0">
            ...
            <li><span><b>Hak-hak Pengelola <?= setting()->nama_aplikasi_frontend ?></b></span>
                <ol class="ordered-list-alpha pl-0">
