...
<section class="sample-text-area p-0">
    <div class="container box_1170">
        ...
        <p class="sample-text">
            Untuk itulah dibentuk SKPM - Zain App sebagai Sistem Keluhan dan Pengaduan Masyarakat yang dibentuk untuk merealisasikan kebijakan yang menjamin hak masyarakat agar pengaduan dapat disalurkan kepada pelayanan publik.
        </p>
    </div>
    <div class="container">
