...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #49b6fe; height: 100%; margin: 0; padding: 0; width: 100%">
    <center>
        <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" id="bodyTable" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust:100%; background-color: #49b6fe; height: 100%; margin: 0; padding: 0; width:100%" width="100%">
            <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #49b6fe;
 ...
 padding: 0'><span style="text-transform:uppercase">Kamu </span></h1>
 ...
 padding: 0'><span style="text-transform:uppercase">lupa password?</span></h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Jangan khawatir, ada kami di sini! Silahkan dapatkan password baru mu.
                                                                <br></br>
                                                            </td>
                                                        </tr>
                                                    </tbody>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                                                                <a class="mcnButton " href="<?= base_url('reset-password') . '?token=' . $hash ?>" style="mso-line-height-rule: exactly;
 ...
 text-align: left; text-align: left; font-size: 14px; '>Seseorang meminta Reset Password di email ini yang berasal dari <?= base_url() ?>. Jika bukan kamu yang meminta, Tolong abaikan saja email ini. <br> Terimakasih ^_^
